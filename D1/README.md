...
#### 資料來源如:網站流量、網站流量量、購物⾞車車紀錄、網路路爬蟲、格式化表單、[Crowdsourcing](https://en.wikipedia.org/wiki/Crowdsourcing)、紙本轉電⼦子檔
## 資料的型態是什麼？
### 1.結構化資料-需要檢視欄欄位意義以及名稱(SQL、CSV、json)
### 2.非結構化資料-需要思考資料轉換與標準化⽅方式(mp4、jpg、text)
## 我們可以回答什麼問題？
### 每個問題都應該要可以被驗證→有一個可供衡量量的數學評估指標
## 作業一
## 作業二